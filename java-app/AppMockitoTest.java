...
/**
 * Mockito-based TDD tests for App.java (Wi-Fi Safety Checker).
 *
 ...
 * Compile & run:
 * javac -cp
 * ".;mockito-core-5.x.jar;byte-buddy-1.x.jar;byte-buddy-agent-1.x.jar;objenesis-3.x.jar;junit-platform-console-standalone-1.x.jar"
 * App.java AppMockitoTest.java
 * java -cp ".;..." org.junit.platform.console.ConsoleLauncher
 * --select-class=AppMockitoTest
 */
